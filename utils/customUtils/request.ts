...
//       }
//       if (!error.response) {
//         toast.error('Request is unable to get response from server.');
//         const json = {
//           error: error,
//         };
//         const obj = {
...
//       if (error && error?.response && error?.response?.status && !error?.response?.config?.url?.includes('graph-module')) {
